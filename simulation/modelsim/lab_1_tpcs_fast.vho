...
-- y1	=>  Location: PIN_40,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
ARCHITECTURE structure OF lab_1_tpcs IS
...
-- Equation(s):
-- \y1~0_combout\ = (\x1~combout\) # ((\x4~combout\ & !\x5~combout\))
